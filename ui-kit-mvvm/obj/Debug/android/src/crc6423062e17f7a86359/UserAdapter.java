...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ui_kit_mvvm.Adapters.UserAdapter, ui_kit_mvvm", UserAdapter.class, __md_methods);
	}
	...
	public UserAdapter ()
	{
		...
		if (getClass () == UserAdapter.class) {
			mono.android.TypeManager.Activate ("ui_kit_mvvm.Adapters.UserAdapter, ui_kit_mvvm", "", this, new java.lang.Object[] {  });
		}
	}
